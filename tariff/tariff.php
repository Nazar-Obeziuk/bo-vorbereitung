...
<head>
    ...
    <link rel="stylesheet" href="../styles/tariff/tariff.css" />
    <link rel="stylesheet" href="../ui/reviews/reviews.css" />
    ...
    <section class='listening-german deutsch-b1-horen'>
        <div class="container">
            <div class="tariff-wrapper">
                <h1>Erhalten Sie <span>uneingeschränkten Zugriff auf alle Übungen</span></h1>

                <div class="tariff-main">
                    <div class="tariff-main_item">
                        <div class="tariff-item_content">
                            <div class="tariff-item_header">
                                <h3 class="tariff-header_title">15 Übungen</h3>
                                <div class="tariff-header_price">
                                    <p class="tariff-header-cost tariff-header_free">Kostenlos</p>
                                </div>
                            </div>
                            <div class="tariff-item_main">
                                <p class="tariff-main_text tariff-main_subtitle">Die ersten 5 Übungen ohne Anmeldung.</p>
                                <p class="tariff-main_text">Die nächsten 10 Übungen nach kostenloser Registrierung</p>
                            </div>
                        </div>
                        <div class="tariff-item_action">
                            <button class="primary-button big" type="send" name="send">Registrieren</button>
                        </div>
                    </div>
                    <div class="tariff-main_item">
                        <div class="tariff-item_content">
                            <div class="tariff-item_header">
                                <h3 class="tariff-header_title">Einmalige Zahlung</h3>
                                <div class="tariff-header_price">
                                    <p class="tariff-header-cost">€7,99</p>
                                </div>
                            </div>
                            <div class="tariff-item_main">
                                <p class="tariff-main_text tariff-main_subtitle">der Zugang ist nur 1 Monat gültig</p>
                                <p class="tariff-main_text">eine Verlängerung ist manuell möglich</p>
                            </div>
                        </div>
                        <div class="tariff-item_action">
                            <button class="primary-button big" type="send" name="send">Bezahlen</button>
                        </div>
                    </div>
                    <div class="tariff-main_item primary">
                        <div class="tariff-item_content">
                            <div class="tariff-item_header">
                                <h3 class="tariff-header_title">Monats Abo</h3>
                                <div class="tariff-header_price">
                                    <p class="tariff-header-cost">€4,99</p>
                                    <p class="tariff-header-cost"><s>€7,99</s></p>
                                </div>
                            </div>
                            <div class="tariff-item_main">
                                <p class="tariff-main_text tariff-main_subtitle">Sie können das Abo <a href="#" class="tariff-subtitle_link">jederzeit kündigen</a></p>
                                <p class="tariff-main_text">Sonst verlängert es sich automatisch um einen Monat</p>
                                <p class="tariff-main_text sparen">XX% sparen</p>
                            </div>
                        </div>
                        <div class="tariff-item_action">
                            <button class="primary-black big" type="send" name="send">Bezahlen</button>
                        </div>
                    </div>
                    <div class="tariff-main_item">
                        <div class="tariff-item_content">
                            <div class="tariff-item_header">
                                <h3 class="tariff-header_title">Einmalige Zahlung</h3>
                                <div class="tariff-header_price">
                                    <p class="tariff-header-cost">€1,99</p>
                                </div>
                            </div>
                            <div class="tariff-item_main">
                                <p class="tariff-main_text tariff-main_subtitle">der Zugang ist nur für 20 Übungen Ihrer Wahl gültig</p>
                            </div>
                        </div>
                        <div class="tariff-item_action">
                            <button class="primary-button big" type="send" name="send">Bezahlen</button>
                ...
                <div class="tariff-info">
                    <h3>Wichtig!</h3>
                    <p class="text p2"><span>Wir erstatten Ihnen Ihr Geld zurück</span>, <br> wenn Sie uns innerhalb einer Woche nach Zahlungseingang schreiben, dass Ihnen unsere Website nicht gefällt und für Sie nicht nützlich war.</p>
                </div>
            </div>
        </div>
    </section>

    <section class="tarrif-reviews_section">
        <div class="container">
            <div class="tariff-block_reviews">
                <h2><span>Feedback</span> unserer Studierenden</h2>
                <div class="tariff-reviews_content">
                            ...
                            <div class="swiper-slide">
                                <div class="review-block">
                                    ...
                                    <div class="review-block_main">
                                        <p class="text p3">Diese Seite ist eine ideale Erfindung, um sich effektiv auf den Ruhm der B1-Prüfung vorzubereiten! Das Beste daran ist, dass Ihnen nicht unklar bleibt, warum Sie sich für diesen Artikel entscheiden sollten. Hier können Sie Hören hören, das Lesen, Schreiben und Beschreiben von Fotos vollständig üben. Generell gibt es keine bessere Seite für die Vorbereitung auf die B1-Prüfung. Ich habe vor, mich mit dieser Seite auch auf B2 vorzubereitens</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="review-block">
                                    ...
                                    <div class="review-block_main">
                                        <p class="text p3">Ich bin wirklich froh, dass ich auf Ihre Website gestoßen bin. Sie hat mir bei der Vorbereitung auf die Prüfung sehr geholfen. Hochwertig, klar, verständlich.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                    ...
                    <span class="arrow-left-reviews arrow__slide_left arrow-reviews">
                        <svg width="13" height="25" viewBox="0 0 13 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M12.5945 1.22875C12.8 1.44467 12.9115 1.73336 12.9043 2.0314C12.8972 2.32944 12.7721 2.61246 12.5564 2.81829L2.78443 12.1329C2.74868 12.1668 2.71999 12.2075 2.7 12.2526C2.68001 12.2977 2.66911 12.3463 2.66793 12.3956C2.66675 12.445 2.6753 12.494 2.69311 12.54C2.71092 12.586 2.73763 12.628 2.77171 12.6637L12.0863 22.4357C12.2798 22.6536 12.3812 22.9382 12.3691 23.2294C12.357 23.5207 12.2323 23.7959 12.0213 23.997C11.8103 24.1981 11.5295 24.3095 11.238 24.3076C10.9465 24.3058 10.6671 24.1909 10.4586 23.9871L1.14407 14.2152C0.9062 13.9656 0.719808 13.6717 0.595541 13.3501C0.471274 13.0286 0.411564 12.6857 0.419823 12.341C0.428082 11.9964 0.504149 11.6567 0.643676 11.3415C0.783204 11.0262 0.983462 10.7416 1.23301 10.5037L11.0049 1.19066C11.2209 0.985094 11.5095 0.873644 11.8076 0.880787C12.1056 0.887929 12.3886 1.01308 12.5945 1.22875Z" fill="#F7631B" />
                        </svg>
                    </span>
                    <span class="arrow-right-reviews arrow__slide_right arrow-reviews">
                        <svg width="13" height="25" viewBox="0 0 13 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M0.405538 1.22875C0.199976 1.44467 0.0885268 1.73336 0.0956691 2.0314C0.102811 2.32944 0.227961 2.61246 0.44363 2.81829L10.2156 12.1329C10.2513 12.1668 10.28 12.2075 10.3 12.2526C10.32 12.2977 10.3309 12.3463 10.3321 12.3956C10.3333 12.445 10.3247 12.494 10.3069 12.54C10.2891 12.586 10.2624 12.628 10.2283 12.6637L0.913744 22.4357C0.72019 22.6536 0.618794 22.9382 0.630918 23.2294C0.643041 23.5207 0.767737 23.7959 0.978735 23.997C1.18973 24.1981 1.47056 24.3095 1.76205 24.3076C2.05354 24.3058 2.33294 24.1909 2.54138 23.9871L11.8559 14.2152C12.0938 13.9656 12.2802 13.6717 12.4045 13.3501C12.5287 13.0286 12.5885 12.6857 12.5802 12.341C12.5719 11.9964 12.4959 11.6567 12.3563 11.3415C12.2168 11.0262 12.0166 10.7416 11.767 10.5037L1.99508 1.19066C1.77916 0.985094 1.49047 0.873644 1.19243 0.880787C0.894388 0.887929 0.611368 1.01308 0.405538 1.22875Z" fill="#F7631B" />
                        </svg>
                    </span>
                </div>
            </div>
