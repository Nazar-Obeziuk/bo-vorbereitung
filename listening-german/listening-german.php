...
<head>
    ...
    <title>Vorbereitung mit BO - B1 Hören</title>
        ...
        <div class="container">
            ...
            <div class="listening-exercises__row">
                    ...
                    <div class="dropdown-menu schprechen-navigation">
                        <div class="dropdown-menu-item" id="dropdown-menu-item-1">
                            <a class="dropdown-menu-item-link active" href="#">
                                ...
                                <div class="check-icon"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path d="M21.5273 6.52734L9 19.0664L2.47266 12.5273L3.52734 11.4727L9 16.9336L20.4727 5.47266L21.5273 6.52734Z" fill="#F7631B"></path>
                                    </svg></div>
                            </a>
                        </div>
                        <div class="dropdown-menu-item" id="dropdown-menu-item-2">
                ...
                <div class="listening-list">
                    ...
                    <div class="listening-list__content" id="listening-list-3">
                        <p class="listening-list__title text p2">Hören Teil 3 - B1 Übungen</p>
                        <div class="listening-list__box">
                            <div class="listening-list__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M4 12.0005L8.94975 16.9502L19.5572 6.34375" stroke="#F7631B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    ...
                    <div class="listening-list__content" id="listening-list-4">
                        <p class="listening-list__title text p2">Hören Teil 4 - B1 Übungen</p>
                        <div class="listening-list__box">
                            <div class="listening-list__icon">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M4 12.0005L8.94975 16.9502L19.5572 6.34375" stroke="#F7631B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
