...
<head>
    ...
    <link rel="stylesheet" href="../styles/sign/sign.css" />
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <div class="breadcrumbs-main">
                ...
                <span>-></span>
                <p class="text p4 bold">Sign Up</p>
            </div>
        </div>
    </section>
    ...
    <section class='listening-german deutsch-b1-horen'>
        <div class="container">
            ...
            <div class="sign-main">
                ...
                <div class="sign-main_block">
                    <div class="sign-block_inner">
                        <h2>Sie machen <span>große Fortschritte!</span></h2>
                        <p class="text p1">Registrieren Sie sich, um weiterzumachen und Ihre Ergebnisse zu speichem.</p>
                            ...
                            <form action="#" method="POST" class="login__form">
                                ...
                                <div class="sign-form_content">
                                    ...
                                    <div class="sign-form_anchor">
                                        <p class="text p3">Already have an account? Log In <a href="#" class="sign-achor_link">Log In</a></p>
                                    </div>
                    ...
                    <div class="sign-block_reviews">
                        <h2><span>Feedback</span> unserer Studierenden</h2>
                        <div class="sign-reviews_content">
