...
<body>
    ...
    <section class="breadcrumbs">
        <div class="container">
            ...
            <p class="text p4">Vorbereiting mit BO -> <span>B1 (Goethe) -> Hören</span></p>
        </div>
    </section>
    ...
    <section class='listening-german deutsch-b1-horen'>
        <div class="container">
            ...
            <div class="box_border">
                <h2 class="level-wrapper_title heading h2"><span>Text</span> für die Aufgaben</h2>
    ...
    <audio id="audio" src="../audio/BRdXYEtmgvCX.128.mp3" controls></audio>
            ...
            <div class="box_border back__width">
                ...
                <h3 class='heading h3'>Aufgaben:</h3>
                ...
                <form method="post" action="#">
                    ...
                    <hr>   
                    <div class="list__">
                        <label class='text p2'> Wo möchte Alex am liebsten übernachten?</label>
                        <span class="input__box border__box">
                            <input class='input_radio' type="radio" name="liebsten" value="bei Verwandten"> bei Verwandten.
                        </span>
                        <span class="input__box border__box">
            ...
            <button class="primary-button border" type="button">Alle Dialoge B1</button>
        </div>
    </section>
    
    <section class="choice-of-exercises">
        <div class="container">
            <h2 class="level-wrapper_title heading h2">Fahren Sie mit den <span>Übungen</span> fort</h2>
