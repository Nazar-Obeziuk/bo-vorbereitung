...
<body>
    ...
    <section class='listening-german deutsch-b1-horen'>
        <div class="container">
            ...
            <script type="text/javascript">
                ...
                const germanListButtons = document.querySelectorAll('.listening-german__list [type="button"]');
                ...
                germanListButtons.forEach((button) => {
                    button.addEventListener('click', function () {
                        ...
                        if (window.innerWidth <= 768) {
                            // Select the '.mob__menu' element
                            const mobMenu = document.querySelector('.mob__menu');
                            
                            // Add the 'open' class to the '.mob__menu' element
    ...
    <section class="choice-of-exercises">
        <div class="container">
            <h2 class="level-wrapper_title heading h2 heading_h2_center">Fahren Sie mit den <span>Übungen</span> fort</h2>
