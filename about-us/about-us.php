...
<head>
    ...
    <title>Vorbereitung mit BO - B1 (Goethe)</title>
    ...
    <link rel="stylesheet" href="../styles/about-us/about-us.css" />
</head>
...
<body>
    ...
    <section class="about-us">
        <div class="container">
            ...
            <img class="hero-image" src="../images/learn-german-hero.webp" alt="Hero image">
            <div class="row">
                <div class="about-us-inner">
                    <h2><span>15 years </span></h2>
                    <p class="text p1"><strong>Experience counts</strong></p>
                    <p class="text p1">since 1952, worldwide presence teaching German.</p>
                    <p class="text p1 about-us-inner__last">The Goethe-Institut is the Republic of Germany’s official cultural institute. With around 270,000 course participants annually, it is the largest provider of German courses worldwide.</p>
                </div>

                <div class="about-us-inner">
                    <h2><span>1120 thousand</span></h2>
                    <p class="text p1"><strong>Course participants</strong></p>
                    <p class="text p1">successfully learnt German at a Goethe-Institut in 2019.</p>
    ...
    <section class="media-library">
        <div class="container">
            <h2>Every media library has <span>four zones:</span></h2>
            <div class="grid">
                <div class="media-library-box">
                    <p class="text p1"><span>Learning</span></p>
                    <p class="text p2">Here you can look for information, prepare for a lesson or an exam without being disturbed.</p>
                </div>
                <div class="media-library-box">
                    <p class="text p1"><span>Communicating</span></p>
                    <p class="text p2">This area is designed for you to engage in conversation, discuss and work with your fellow students.</p>
                </div>
                <div class="media-library-box">
                    <p class="text p1"><span>Informing</span></p>
                    <p class="text p2">In this zone, you will find learning materials, information about Germany, books and presentations.</p>
                </div>
                <div class="media-library-box">
                    <p class="text p1"><span>Relaxing</span></p>
                    <p class="text p2">This is where you can relax and drink some coffee or read a newspaper.</p>
                </div>
            </div>
    ...
    <section class="guarantee">
        <div class="container">
            <h2>The Deutsch Vorbereitung <span>guarantee</span></h2>
